  ...
  const nextSteps = useMemo(
    () => [
      ...
      },
      {
        ...
        description: "We’ve created a Go Green account with your email so you can view quotes, receipts, and future visits.",
        icon: ShieldCheck
      },
      {
      ...
      <Card className="bg-white">
        <CardHeader className="space-y-3 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            We’ve created a Go Green account for {quote.form.name}. Use the steps below to confirm your visit.
          </p>
        </CardHeader>
        <CardContent className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-3xl border border-brand-100 bg-brand-50/40 p-5 text-sm text-muted-foreground">
              <p>
                Keep an eye out for a welcome email with your Go Green account login. From there you’ll be able to update payment methods,
