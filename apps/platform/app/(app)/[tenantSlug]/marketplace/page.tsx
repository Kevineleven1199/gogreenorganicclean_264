  ...
  <div className="space-y-6">
    <header className="rounded-3xl border border-white/10 bg-white/5 p-6 text-white">
      ...
      <p className="mt-2 max-w-3xl text-sm text-white/70">
        Jobs are released to pre-vetted crews and auto-claimed based on rating,
        travel time, and specialization. Every payout automatically splits 65%
        to your cleaner via Wise, Zelle, or PayPal with 1099 tracking.
      </p>
