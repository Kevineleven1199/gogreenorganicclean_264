...
<div class="frmn-main-div">
    <div class="frmn-bread-crumb">
        ...
        <a href="?page=formntr-gsheet-config&tab=google-sheet">
            <button class="back-button"><span class="back-icon">&#8592;</span><?php echo esc_html(__('Back to Forms List', 'gsheetconnector-forminator')); ?></button>
        </a>
    
        <a href="?page=formntr-gsheet-config&tab=google-sheet&form_id=<?php echo $form_id; ?>">
            <button class="back-button"><span class="back-icon">&#8592;</span> <?php echo esc_html(__('Back to Feeds List', 'gsheetconnector-forminator')); ?></button>
        </a>
            
    </div>

    <div class="frmn-modal-content">
        <h2 class="info-headers"><?php echo esc_html(__('Edit Feed and Integrate with Google Sheets', 'gsheetconnector-forminator')); ?></h2>
        
        <form id="edit-feed-form" method="post">
            <input type="hidden" id="edit-feed-id" name="edit_feed_id" value="<?php echo $feed_id; ?>">
            <input type="hidden" id="edit-form-id" name="edit_form_id" value="<?php echo $form_id; ?>">

            <label for="edit-sheet-name"><?php echo esc_html(__('Sheet Name:', 'gsheetconnector-forminator')); ?></label>
            <input type="text" id="edit-sheet-name" name="edit_sheet_name" value="<?php echo $sheet_name; ?>">
            <br>
            <label for="edit-sheet-id"><?php echo esc_html(__('Sheet ID:', 'gsheetconnector-forminator')); ?></label>
            <input type="text" id="edit-sheet-id" name="edit_sheet_id" value="<?php echo $sheet_id; ?>">
            <br>
            <label for="edit-tab-name"><?php echo esc_html(__('Tab Name:', 'gsheetconnector-forminator')); ?></label>
            <input type="text" id="edit-tab-name" name="edit_tab_name" value="<?php echo $tab_name; ?>">
            <br>
            <label for="edit-tab-id"><?php echo esc_html(__('Tab ID:', 'gsheetconnector-forminator')); ?></label>
            <input type="text" id="edit-tab-id" name="edit_tab_id" value="<?php echo $tab_id; ?>">
            <br>
            ...
            echo '<a href="' . $link . '" target="_blank" class="google-sheets-button">View in Google Sheets</a>';

             } echo '<br><br>'; ?>
             <input type="submit" name="execute-edit-feed-forminator" value="Save Changes" id="execute-edit-feed-forminator"class="button button-primary" />
            <input type="hidden" name="frmntr-form-gs-ajax-nonce" id="frmntr-form-gs-ajax-nonce"
                    value="<?php echo wp_create_nonce('frmntr-form-gs-ajax-nonce'); ?>" />
        </form>
    </div>
</div>
...
<div class="system-debug-logs" id="opener">
        ...
        <div class="auto-section" style="display:block">
            <div class="gs-fields">
            <h3><?php echo __('Auto Sheet and Tab Names', 'gsheetconnector-forminator'); ?><span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span></h3>
                ...
                <div class="sheet-details ">
                    <p>
                        ...
                        <select name="forminatorform-gs[gs-wpcore-sheet-id]" id="gs-wpcore-sheet-id">
                            ...
                            <option value="create_new"><?php echo esc_html(__('Create New', 'gsheetconnector-forminator')); ?></option>
                        </select>
                ...
                <div class="create-ss-wrapper" style="display: none" ;>
                    ...
                    <input type="text" name="_gs_forminator_setting_create_sheet" value="" id="_gs_forminator_setting_create_sheet">
                ...
                <p id="gs-valid-message"></p>
                    ...
                    <?php if (!empty(get_option('gs_formntr_verify')) && (get_option('gs_formntr_verify') == "valid")) { ?>
                        ...
                        <p class="gs-wpcore-sync-row">
                            <a id="gs-wpcore-sync" data-init="yes" class="sync-button"><?php echo esc_html__('Click here', 'gsheetconnector-forminator'); ?></a>
        ...
        <div class="form-fields-list gs-frmnt-list-set1" >
              ...
              <div class="forminatorgs-color-code">
                        <div class="color-forminatorgs">
                            <p><?php echo __('Field List', 'gsheetconnector-forminator'); ?><span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span></p>
                            <p class="Fl"></p>
                        </div>
                        <div class="color-forminatorgs">
                            <p><?php echo __('Special Mail Tags', 'gsheetconnector-forminator'); ?><span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span></p>
                            <p class="SM"></p>
                        </div>
            ...
            <div class="toggle-button select-all-toggle">
                ...
                <span class="label-text"><?php echo __('Select All', 'gsheetconnector-forminator'); ?></span>
            </div>
            <div id="sortable">
          ...
          $default_mail_tags = array(
             ...
             foreach ($form_merged_array as $key => $field) {
                     $field_label = $key;
                           ...
                           if($key == "Submission ID" || $key == "Date Submitted" || $key == "Post ID" || $key == "Post Title" || $key == "Post URL" || $key == "Date & Time" || $key == "Source URL" || $key == "User ID" || $key == "User Agent" || $key == "IP Address"){
                            ...
                            echo '<input type="checkbox" name="sheet_header[' . $field_label . ']" class="toggle-input" value="1">'; 
                            echo '<span class="slider round"></span>';
                            echo '</label>';
                            echo '<span class="label-text">' . esc_html($field_label) . '</span>';
                            echo '<div class="info-row" id="' . $field . '_row">';
                            ...
                            echo '<input type="text" class="info-content" name="sheet_header_names[' . $field_label . ']" placeholder="'. esc_html($field_label).'" value="' . esc_html($field_label) . '">';
            ...
            <div class="freez_order_sort">
                 <h3><?php echo __('Header Settings', 'gsheetconnector-forminator'); ?> <span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span></h3>
                <div class="gscfrmnt-cards gscfrmnt-card">
                    <div class="toggle-button freeze-header-toggle">
                        <label class="switch">
                            <input type="checkbox" id="freeze-header-checkbox" name="forminatorform-gs[freeze_header]" value="true" >
                            <span class="slider round"></span>
                        </label>
                         <div class="label-container">
                            <span class="label-text"><?php echo __('Freeze Header', 'gsheetconnector-forminator'); ?></span>
                            <span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span>
                        </div>
                ...
                <div class="gscfrmnt-sheet_formatting gscfrmnt-sheet_formatting">
                    <div class="toggle-button sheet_formatting-header-toggle">
                        <label class="switch" for="sheet_formatting-header-checkbox">
                            <input type="checkbox" id="sheet_formatting-header-checkbox" name="forminatorform-gs[sheet_formatting_header]" value="1" >
                            <span class="slider round"></span>
                        </label>
                        <span class="label-texts"><?php echo __('Header - Font Settings', 'gsheetconnector-forminator'); ?></span>
                        <span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span>
                    </div>
                </div>
                ...
                <div class="misc-options-row">
                    <div class="misc-options-wrapper">
                        <div class="toggle-button sheet-bg-toggle">
                            <label class="switch">
                                <input type="checkbox" id="sheet-bg-toggle-checkbox" name="forminatorform-gs[sheet_bg]" value="1" >
                                <span class="slider round"></span>
                            </label>
                            <span class="label-texts"><?php echo __('Sheet Background Color', 'gsheetconnector-forminator'); ?></span>
                             <span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span>
                    ...
                    <div class="gscfrmnt-sheet_formatting_row gscfrmnt-sheet_formatting_row">
                        <div class="toggle-button sheet_formatting-row-toggle">
                            <label class="switch" for="sheet_formatting-row-checkbox">
                                <input type="checkbox" id="sheet_formatting-row-checkbox" name="forminatorform-gs[sheet_formatting_row]" value="1" >
                                <span class="slider round"></span>
                            </label>
                            <span class="label-texts"><?php echo __('Row - Font Settings', 'gsheetconnector-forminator'); ?></span>
                             <span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="gs-wpcore-sync-entries">
                ...
                <a id="gs-wpcore-sync-entries" data-init="yes" class="sync-button-entries"><?php echo esc_html__('Click Here to Sync Entries.', 'gsheetconnector-forminator'); ?></a>
                 <span class="pro-ver"><?php echo __('PRO', 'gsheetconnector-forminator'); ?></span>
            </div>
</div>
<!-- popup file include herre -->
<?php include( GS_FORMNTR_PATH . "includes/pages/pro-popup.php" ) ;?>
