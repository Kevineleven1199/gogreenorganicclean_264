    ...
    <div class="frmn-bread-crumb">
        ...
        <a href="?page=formntr-gsheet-config&tab=google-sheet">
            <button class="back-button">
                <span class="back-icon">&#8592;</span> <?php echo __(' Back to Forms List', 'gsheetconnector-forminator'); ?>
            </button>
        </a>
            <button class="frmn-btn" id="add-new-feed">
               <?php echo __('+ Add Feed to Form', 'gsheetconnector-forminator'); ?>
            </button>
    </div>
    ...
    <div class="frmn-row">
        <table>
            <thead>
                <?php if (!empty($feeds)) { ?>
                    <tr>
                        <th scope="col"><?php echo __('Sr No', 'gsheetconnector-forminator'); ?></th>
                        <th scope="col"><?php echo __('Feed Name', 'gsheetconnector-forminator'); ?></th>
                        <th scope="col"><?php echo __('Edit Feed', 'gsheetconnector-forminator'); ?></th>
                        <th scope="col"><?php echo __('Delete Feed', 'gsheetconnector-forminator'); ?></th>
                    </tr>
                <?php } ?>
            </thead>
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td data-label="Edit Feed">
                                <a href="?page=formntr-gsheet-config&tab=google-sheet&form_id=<?php echo $form_id ?>&feed_id=<?php echo $feed_id ?>">
                                   <button class="edit-feed">
                                        <span class="button-text"><?php echo __(' Edit Feed and Integrate with Google Sheets', 'gsheetconnector-forminator'); ?></span>
                                    </button>

                                </a>
                            </td>
                            <td data-label="Delete Feed">
                                <button class="delete-feed" data-feed-id="<?php echo $feed_id; ?>">
                                     <span class="button-text"><?php echo __('Delete this feed.', 'gsheetconnector-forminator'); ?></span>
                                </button>
                            </td>
                        </tr>
                <?php
                ...
                ?>
                    <tr>
                        <td colspan="3">
                           <h3> <?php echo __('No Feeds Found!', 'gsheetconnector-forminator'); ?></h3>
                       </td>
                    </tr>
                <?php
                }
        ...
        <div class="add-feed-popup-container">
            <form method="post">
                <div class="add-feed-popup-header">
                    <h3><?php echo __('Add Feed', 'gsheetconnector-forminator'); ?></h3>
                    <button type="button" class="frmn-close-btn" id="close-add-feed-popup">&times;</button>
                </div>
                <div class="add-feed-popup-body">
                    <label for="feed_name"><?php echo __('Feed Name', 'gsheetconnector-forminator'); ?></label>
                ...
                <input type="hidden" name="frmntr-gs-feed-ajax-nonce" id="frmntr-gs-feed-ajax-nonce"
                  value="<?php echo wp_create_nonce('frmntr-gs-feed-ajax-nonce'); ?>" />
                <div class="add-feed-popup-footer">
                    <input type="submit" name="execute-submit-feed-forminator" class="frmn-gs-sub-btn" value="<?php echo __("Submit", "gsheetconnector-forminator"); ?>">
                </div>
            </form>
        </div>
    </div>
